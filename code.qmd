...
4) Représenter graphiquement l’évolution des prévisions des différents modèles et 
commenter. 
5) Qualité de prévision : calculer les MSE et R2OOS de tous les modèles précédents (3a) et 
définir le meilleur modèle. Comparer les à celles d’une prévision naïve. Faire également 
le graphique des CSPE.
